...
def ARnettest(cfg, dataset, outdir, modelname):
    
    model = DenseED(dataset.nx, dataset.ny,blocks=cfg.blocks, growth_rate=cfg.growth_rate,
...
if __name__ == '__main__':
    ...
    dLsm, vicsm = ARnettest(cfg, testset, outdir, modelname)
