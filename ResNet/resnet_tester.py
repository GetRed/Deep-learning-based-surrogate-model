...
def ResNettest(cfg, dataset, outdir, modelname):
    
    model = ResnetGenerator_c(dataset.nx, dataset.ny,ngf=32, norm_layer=nn.BatchNorm2d, use_dropout=False, padding_type='zero' )
...
if __name__ == '__main__':
    ...
    testset = ResNetDataset(cfg, fvarLst, pvarLst, ovarLst, fileidx, trange, is_train=False)
    ...
    dLsm, vicsm = ResNettest(cfg, testset, outdir, modelname)
